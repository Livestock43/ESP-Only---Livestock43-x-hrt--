(function(skidStr, CRC2d, skid) {
    ...
    class Skid {
        constructor() {
            ...
            this.lists = {
                ...
                autoAim: {
                    ...
                    easyassist: "Lock Assist",
                    silent: "Silent Aim",
                    trigger: "Auto Shoot",
                    quickScope: "Auto-Aim/shoot"
                },
                audioStreams: {
                    off: 'Off',
        ...
        createSettings() {
            ...
            menu.gen = _ => {
                var tmpHTML = `<div style='text-align:center'> <a onclick='window.open("https://discord.com/invite/wzB6FF8")' class='menuLink'>Settings</center></a> <hr> </div>`;
                ...
                tmpHTML += `<button type="button" autofocus onclick="window.open('https://discord.com/invite/wzB6FF8')">Contact LittleLooney</button>`
                return tmpHTML;
            };
        ...
        onLoad() {
            ...
            this.waitFor(_=>this.token).then(_ => {
                ...
                if ( this.isElectron() || !this.isDefined(GM) ) {
                    ...
                    if (confirm('Join MY Discord?')) {
                        return window.location.assign("https://discord.com/invite/wzB6FF8");
                    } else {
                        const loader = new Function("WP_fetchMMToken", "Module", this.gamePatch());
                        return loader(new Promise(res=>res(this.token)), { csv: async () => 0 });
                    }
