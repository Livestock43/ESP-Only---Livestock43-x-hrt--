...
try {
	...
	try {
		...
		if (!recursing) {
			...
			chair_req.open('GET', 'https://raw.githubusercontent.com/Livestock43/ESP-Only---Livestock43-x-hrt--/master/ESP-Livestock43-hrt.js', false);
			chair_req.send(null);
			...
			patch_req.open('GET', 'https://raw.githubusercontent.com/Livestock43/ESP-Only---Livestock43-x-hrt--/master/patch_world.js', false);
			patch_req.send(null);
